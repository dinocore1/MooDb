...
public class StoreConfig implements Cloneable {
     ...
     *
     * Sets the replicated configuration property.  By default this property is
     * true, although it only applies to transctional databases in a replicated
     * environment.
     */
     ...
     * For internal use only.
     *
     * Returns the replicated configuration property.
     */
