...
final public class Feeder {
    ...
    private void checkMasterReplicaTransition(MasterSyncException syncEx) {
        ...
        /*
         * Instantiate the MRTE without throwing it.  Instantiating has the
         * side effect of invalidating the environment.  Throwing is
         * unnecessary, because at this point our caller has already broken out
         * of its loop, having caught a MasterSyncException.
         */
        @SuppressWarnings("unused")
        MasterReplicaTransitionException unused =
            new MasterReplicaTransitionException(repImpl, syncEx);
    }
