...
public abstract class TextProtocol {
    ...
    public class MessageExchange implements Runnable {
         ...
         * <p>
         * Note: MasterTransfer currently returns null upon success (there may
         * be others), it would be preferable if they returned an explicit OK
         * response if possible. Need to review.
         *
         * @return the response
         */
