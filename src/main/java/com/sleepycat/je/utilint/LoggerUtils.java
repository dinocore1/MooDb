...
public class LoggerUtils {
    ...
    private static Logger createLogger(String className) {
        ...
        /*
         * We've debated permitting the logger to use parental handlers, which would
         * permit using the standard java.util.logging policy of setting tbe property
         * com.sleepycat.je.handlers as a way of customizing handlers. This was
         * not useful because of the need to specify handlers per environment, and
         * also caused a process monitor echo issue within Katana.
         */
